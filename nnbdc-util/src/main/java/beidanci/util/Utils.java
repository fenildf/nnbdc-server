...
public class Utils {
    ...
    public static String purifySpell(String spell) {
        ...
        while (spell.endsWith(",") || spell.endsWith("?")
        ...
        while (spell.startsWith("\"") || spell.startsWith("”")
                || spell.startsWith("'") || spell.startsWith("(")) {
    ...
    public static <T> List<T> abstractEntityFromList(List<Object> objects, Class<T> clazz) {
        List<T> entities = new ArrayList<T>(objects.size());
        if (objects.size() > 0) {
            ...
            for (Object object : objects) {
                if (isEntity) {
                    ...
                    entities.add((T) ((Object[]) object)[atIndex]);
                }
            }
        }
        return entities;
