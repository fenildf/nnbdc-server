...
public class GetSentenceToTranslate {
	...
	public String handle(HttpServletRequest request, HttpServletResponse response) throws SQLException, NamingException,
		...
		int totalCount = sentenceDAO.getCountOfSentencesToTranslate(Sentence.HUMAN_AUDIO);
		...
		List<Sentence> sentences = sentenceDAO.getSentencesToTranslate(firstRow, pageSize, Sentence.HUMAN_AUDIO);
